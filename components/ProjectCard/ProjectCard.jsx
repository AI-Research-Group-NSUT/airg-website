            ...
            <div onMouseEnter={show} onMouseLeave={hide} >
                ...
                <div ref={ref} className={`${styles.container} ${inView ? styles.active : ''}`}>
                    <div className={styles.imageContainer}>
                        <Image priority layout='responsive' className={styles.image} src={`/project-images/${project.imagePath}.jpeg`} width={392} height={264} alt={project.title} /> {/* assuming that image name is the same as the title */}
                    </div>
