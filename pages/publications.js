  ...
  return (
    <div className={`project ${styles.container}`}>
      ...
      <div className={styles.publicationsContainer}>
        <ShowcaseCard description={lorem} heading='Publication 1' imageSrc={'/publication-images/publication-1.jpeg'} subtitle='Mohit Chaurasiya, Vinamra Harkar, Poojan' />
        <ShowcaseCard description={lorem} heading='Publication 2' imageSrc={'/publication-images/publication-2.jpeg'} subtitle='Mohit Chaurasiya, Vinamra Harkar, Poojan' />
        <ShowcaseCard description={lorem} heading='Publication 3' imageSrc={'/publication-images/publication-3.jpeg'} subtitle='Mohit Chaurasiya, Vinamra Harkar, Poojan' />
      </div>
    </div>
  );
};
